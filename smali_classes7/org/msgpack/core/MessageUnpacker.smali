...
.method private static unexpected(Ljava/lang/String;B)Lorg/msgpack/core/MessagePackException;
    ...
    .line 27
    :cond_0
    invoke-virtual {v0}, Lorg/msgpack/core/MessageFormat;->getValueType()Lp/ywz0;
...
.method public unpackValue(Lp/bxz0;)Lp/bxz0;
    .locals 5
    ...
    invoke-virtual {p1}, Lorg/msgpack/core/MessageFormat;->getValueType()Lp/ywz0;
...
.method public unpackValue()Lp/r2z;
    .locals 5
    ...
    .line 6
    new-instance v2, Lp/u0z;

    invoke-direct {v2, v1, v0}, Lp/u0z;-><init>(B[B)V
    ...
    sget-object v0, Lp/p1z;->b:Lp/p1z;
    ...
    sget-object v0, Lp/f0z;->b:Lp/f0z;
    ...
    .line 18
    new-instance v1, Lp/l0z;

    .line 19
    invoke-direct {v1, v0}, Lp/s4;-><init>([B)V
    ...
    .line 25
    new-instance v2, Lp/s0z;

    invoke-direct {v2, v0, v1}, Lp/s0z;-><init>(D)V
    ...
    .line 28
    new-instance v2, Lp/g1z;

    invoke-direct {v2, v0, v1}, Lp/g1z;-><init>(J)V
    ...
    .line 30
    new-instance v1, Lp/j0z;

    invoke-direct {v1, v0}, Lp/j0z;-><init>(Ljava/math/BigInteger;)V
    ...
    sget-object v0, Lp/o0z;->b:Lp/o0z;

    goto :goto_4

    :cond_5
    sget-object v0, Lp/o0z;->c:Lp/o0z;
    ...
    sget-object v0, Lp/w1z;->a:Lp/w1z;
